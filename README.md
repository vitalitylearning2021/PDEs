...
<p align="center">
  <img src="https://render.githubusercontent.com/render/math?math=\frac{T_{m,n}^{k+1}-T_{m,n}^{k}}{\Delta t}=\frac{T_{m+1,n}^{k}-2T_{m,n}^{k} 2%B T_{m-1,n}^{k}}{\Delta t}." id="heatEquationExpanded">       [3]
</p>
